...
2. **현재가, NAV, 가격 정보는 반드시 포함하세요 (문서에 있는 경우)**
3. 확실하지 않은 정보는 추측하지 말고, 문서에 없다고 명시하세요
4. 답변의 근거가 되는 문서 번호를 [문서 N] 형태로 인용하세요
5. 투자 조언이 아닌 정보 제공에 초점을 맞추세요
6. 명확하고 구조화된 답변을 제공하세요
7. 여러 ETF를 비교할 때는 각 ETF의 가격 정보를 빠짐없이 포함하세요"""
